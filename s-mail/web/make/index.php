<?php
	...
	/*
		Submit an email message to the local postfix server
	*/
	...
	if (isset($_POST) && isset($_POST["dest"]))
	{
		...
		$maau = trim(file_get_contents($mail."/"."server.auth"));
...
<html>
	...
	<body onload="jQuery('#dest').focus(); getkeyi(user, '#keyi'); msgdec('make'); procdest({'keyCode':21});">
									...
									<div class="panel-body" style="color: #333;">
										<div class="form-group">
											...
											<div class="col-sm-6 input-group-sm">
												<input type="text" name="dest" id="dest" class="form-control" placeholder="alice@host.com , bob@host.com , ....." value="<?php print($eadr); ?>" onkeyup="procdest(event);" />
											</div>
