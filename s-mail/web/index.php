			...
			<table style="width: 75%;">
				...
				<tr><td colspan="3">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title"><b>Home Page News! - Secure Email [S-Mail]</b></h3>
						</div>
						<div class="panel-body" style="color: #333;">
							...
							<ul>
								...
								<li>Compatible with standard email</li>
								<li>Web/API based (Clients can be made also)</li>
								<li>and...</li>
								<li>Open source (verify then trust)</li>
							</ul>
							...
							What are the downsides to a system like this?
							 ...
							 &nbsp; <br />
							<ul>
								<li>Higher client side data processing overhead lead to slower speeds</li>
								<li>No server-side searching or filtering</li>
								<li>No crowd-sourced spam filtering</li>
								<li>JavaScript/ClientSide-Script Heavy</li>
								<li>HTML/JS framework not signed by server or verified by client</li>
							</ul>
				...
				<tr><td colspan="3">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h3 class="panel-title"><b>Proof Of Work</b></h3>
						</div>
						<div class="panel-body" style="color: #333;">
